...
export const askLLM = async (prompt: string, fileUrls?: string[]): Promise<string> => {
    ...
    // 2. Add PDFs as native file objects (Base64)
    ...
    const response = await aiClient.chat.completions.create({
        model: "gpt-4o", // Must use gpt-4o or gpt-4o-mini
